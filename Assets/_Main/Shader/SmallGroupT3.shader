...
{
    float4 part1Pos = mul(_Part11, float4(wpos, 1.0));
    float4 part2Pos = mul(_Part12, float4(wpos, 1.0));
    float4 part3Pos = mul(_Part13, float4(wpos, 1.0));
    float4 part4Pos = mul(_Part14, float4(wpos, 1.0));
    float4 part5Pos = mul(_Part15, float4(wpos, 1.0));
