...
{
    float4 part1Pos = mul(_Part6, float4(wpos, 1.0));
    float4 part2Pos = mul(_Part7, float4(wpos, 1.0));
    float4 part3Pos = mul(_Part8, float4(wpos, 1.0));
    float4 part4Pos = mul(_Part9, float4(wpos, 1.0));
    float4 part5Pos = mul(_Part10, float4(wpos, 1.0));
